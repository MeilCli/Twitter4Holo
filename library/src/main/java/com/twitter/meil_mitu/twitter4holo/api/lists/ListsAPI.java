...
public class ListsAPI extends AbsAPI<ITwitterJsonConverter>{
    ...
    public Statuses statuses(long listId){
        return new Statuses(Oauth, Json, listId);
    }

    public Statuses statuses(String slug){
        return new Statuses(Oauth, Json, slug);
    }
    ...
    public Memberships memberships(){
        return new Memberships(Oauth, Json);
    }
    ...
    public Update update(long listId){
        return new Update(Oauth, Json, listId);
    }

    public Update update(String slug){
        return new Update(Oauth, Json, slug);
    }
    ...
    public Show show(long listId){
        return new Show(Oauth, Json, listId);
    }

    public Show show(String slug){
        return new Show(Oauth, Json, slug);
    }

    public Subscriptions subscriptions(){
        return new Subscriptions(Oauth, Json);
    }

    public Ownerships ownerships(){
        return new Ownerships(Oauth, Json);
    }
