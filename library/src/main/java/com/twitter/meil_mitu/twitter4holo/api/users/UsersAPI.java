...
public class UsersAPI extends AbsAPI<ITwitterJsonConverter>{
    ...
    public Lookup lookup(){
        return new Lookup(Oauth, Json);
    }

    public Show show(long userId){
        return new Show(Oauth, Json, userId);
    }

    public Show show(String screenName){
        return new Show(Oauth, Json, screenName);
    }

    public Search search(String q){
        return new Search(Oauth, Json, q);
    }

    public ProfileBanner profileBanner(){
        return new ProfileBanner(Oauth, Json);
    }
    ...
    public ReportSpam reportSpam(){
        return new ReportSpam(Oauth, Json);
    }
