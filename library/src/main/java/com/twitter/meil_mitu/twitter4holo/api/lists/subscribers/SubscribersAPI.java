...
public class SubscribersAPI extends AbsAPI {

    public SubscribersAPI(AbsOauth oauth, AbsJsonConverter json) {
        super(oauth, json);
    }
    ...
    public Create create(long listId){return new Create(Oauth,Json,listId);}

    public Create create(String slug){return new Create(Oauth,Json,slug);}
    ...
    public Show show(String slug,String screenName){return new Show(Oauth,Json,slug,slug);}
