...
public class Oauth extends AbsOauth{
    ...
    public Oauth(Twitter4HoloConfig config, String consumerKey, String consumerSecret){
        super(true, config, consumerKey, consumerSecret);
    }
    ...
    protected Oauth(boolean isRequireConsumer, Twitter4HoloConfig config, String consumerKey, String consumerSecret){
        super(isRequireConsumer, config, consumerKey, consumerSecret);
    }

    protected Oauth(boolean isRequireConsumer, Twitter4HoloConfig config, String consumerKey, String consumerSecret, String accessToken, String accessTokenSecret){
        super(isRequireConsumer, config, consumerKey, consumerSecret);
        this.AccessToken = accessToken;
        this.AccessTokenSecret = accessTokenSecret;
    }
