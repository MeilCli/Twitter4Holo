...
public class CreateAll extends AbsPost {

    public CreateAll(AbsOauth oauth, AbsJsonConverter json,long listId) {
        super(oauth, json);
        addParam("list_id",listId);
    }

    public CreateAll(AbsOauth oauth, AbsJsonConverter json,String slug) {
        super(oauth, json);
        addParam("slug",slug);
    }
