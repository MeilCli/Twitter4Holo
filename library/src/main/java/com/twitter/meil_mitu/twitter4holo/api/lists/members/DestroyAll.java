...
public class DestroyAll extends AbsPost <ITwitterJsonConverter>{

    public DestroyAll(AbsOauth oauth, ITwitterJsonConverter json,long listId) {
        super(oauth, json);
        addParam("list_id",listId);
    }

    public DestroyAll(AbsOauth oauth, ITwitterJsonConverter json,String slug) {
        super(oauth, json);
        addParam("slug",slug);
    }

    public DestroyAll userId(long[] userId){
        addParam("user_id", Utils.toString(userId));
        return this;
    }

    public DestroyAll screenName(String[] screenName){
        addParam("screen_name",Utils.toString(screenName));
        return this;
    }

    public DestroyAll ownerScreenName(String ownerScreenName){
        addParam("owner_screen_name",ownerScreenName);
        return this;
    }

    public DestroyAll ownerId(long ownerId){
