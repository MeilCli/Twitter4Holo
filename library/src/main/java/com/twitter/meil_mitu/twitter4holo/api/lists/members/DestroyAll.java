...
public class DestroyAll extends AbsPost {

    public DestroyAll(AbsOauth oauth, AbsJsonConverter json,long listId) {
        super(oauth, json);
        addParam("list_id",listId);
    }

    public DestroyAll(AbsOauth oauth, AbsJsonConverter json,String slug) {
        super(oauth, json);
        addParam("slug",slug);
    }
