...
public class Show extends AbsGet<ITwitterJsonConverter>{
    ...
    public Show(AbsOauth oauth, ITwitterJsonConverter json, long listId, long userId){
        super(oauth, json);
        addParam("list_id", listId);
        addParam("user_id", userId);
    }

    public Show(AbsOauth oauth, ITwitterJsonConverter json, long listId, String screenName){
        super(oauth, json);
        addParam("list_id", listId);
        addParam("screen_name", screenName);
    }

    public Show(AbsOauth oauth, ITwitterJsonConverter json, String slug, long userId){
        super(oauth, json);
        addParam("slug", slug);
        addParam("user_id", userId);
    }

    public Show(AbsOauth oauth, ITwitterJsonConverter json, String slug, String screenName){
        super(oauth, json);
        addParam("slug", slug);
        addParam("screen_name", screenName);
    }
