...
public class Retweet extends AbsPost<ITwitterJsonConverter>{

    private long id;

    public Retweet(AbsOauth oauth, ITwitterJsonConverter json, long id){
        super(oauth, json);
        this.id = id;
    }
     ...
     */
    public Retweet trimUser(boolean trimUser){
    ...
    @Override
    public String url(){
        return "https://api.twitter.com/1.1/statuses/retweet/" + id + ".json";
    }
